 ...
 * func12
 */
export function setFilament(
	serial: string,
	setFilamentDto: SetFilamentDto,
	{
		accept
	}: {
		accept?: string;
	...
	return oazapfts.ok(
		...
		>(
			`/api/printer/${encodeURIComponent(serial)}/filament`,
			oazapfts.json({
				...opts,
				method: 'POST',
				body: setFilamentDto,
...
export function setLight(
	...
	return oazapfts.ok(
		...
		>(
			`/api/printer/${encodeURIComponent(serial)}/light`,
			oazapfts.json({
				...opts,
				method: 'POST',
				body: setLightDto,
 ...
 * func10
 */
export function setPrintSpeed(
	serial: string,
	setPrintSpeedDto: SetPrintSpeedDto,
	{
		accept
	}: {
		accept?: string;
	...
	return oazapfts.ok(
		...
		>(
			`/api/printer/${encodeURIComponent(serial)}/speed`,
			oazapfts.json({
				...opts,
				method: 'POST',
