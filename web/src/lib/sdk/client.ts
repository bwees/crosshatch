...
export function deletePrinter(serial: string, opts?: Oazapfts.RequestOpts) {
	return oazapfts.ok(
		oazapfts.fetchText(`/api/printer/${encodeURIComponent(serial)}`, {
			...opts,
			method: 'DELETE'
		})
	);
...
export function stopPrint(serial: string, opts?: Oazapfts.RequestOpts) {
	return oazapfts.ok(
		oazapfts.fetchText(`/api/printer/${encodeURIComponent(serial)}/stop`, {
			...opts,
			method: 'POST'
		})
	);
...
export function pausePrint(serial: string, opts?: Oazapfts.RequestOpts) {
	return oazapfts.ok(
		oazapfts.fetchText(`/api/printer/${encodeURIComponent(serial)}/pause`, {
			...opts,
			method: 'POST'
		})
	);
...
export function resumePrint(serial: string, opts?: Oazapfts.RequestOpts) {
	return oazapfts.ok(
		oazapfts.fetchText(`/api/printer/${encodeURIComponent(serial)}/resume`, {
			...opts,
			method: 'POST'
		})
	);
